                    ...
                    case "B":
                        ...
                        if (back) {
                            System.out.printf("You drove the %d, %s, %s %.2f miles and returned it to its parking space.%n",
                                    car.getYear(), car.getMake(), car.getModel(), dist);
                            garage.parkCar(car);
                        } else {
                            System.out.printf("The %s ran out of fuel.%n", car.getModel());
