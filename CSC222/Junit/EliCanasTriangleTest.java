...
public class EliCanasTriangleTest {
	...
	@Test
	public void test12(){
		Triangle triangle = new Triangle("3","b","4");
		assertEquals("The side 2 is not an integer number.\n\nNot a valid triangle!\n", triangle.triangleType());
	}//end test
	
	@Test
	public void test13(){
		Triangle triangle = new Triangle("3","4","c");
	...
	@Test
	public void test15(){
		Triangle triangle = new Triangle("-100","600","600");
		assertEquals(
